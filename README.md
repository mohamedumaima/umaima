...
- 🌐 Diploma in English
- 💻 Certificate in MS Office Packages

---

## 🤝 Soft Skills

`Teamwork` · `Project Management` · `Time Management` · `Problem Solving` · `Active Learning` · `Critical Thinking` · `Effective Communication` · `Creativity` · `Leadership`
...
<p align="center">
  <em>"Committed to delivering high-quality work, fostering innovation, and growing alongside a team that values excellence."</em>
</p>
